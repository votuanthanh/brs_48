<div class="btn-pref btn-group btn-group-justified btn-group-lg" role="group" aria-label="...">
    <div class="btn-group" role="group">
        <a id="favorites"
            ...
            <div class="hidden-xs"> {{ trans('common.text.favorite_book') }}</div>
        </a>
    </div>
    <div class="btn-group" role="group">
        <a id="following"
            ...
            <div class="hidden-xs">{{ trans('common.text.request_book') }}</div>
        </a>
    </div>
    <div class="btn-group" role="group">
        <a id="stars"
            ...
            <div class="hidden-xs">{{ trans('common.text._book') }}</div>
        </a>
    </div>
    <div class="btn-group" role="group">
        <a id="following"
    ...
    <div class="btn-group" role="group">
        <a id="following"
            ...
            <div class="hidden-xs">{{ trans('common.text.read_book') }}</div>
        </a>
    </div>
    <div class="btn-group" role="group">
        <a id="following"
            ...
            <div class="hidden-xs">{{ trans('common.text.following') }}</div>
        </a>
    </div>
    <div class="btn-group" role="group">
        <a id="following"
            ...
            <div class="hidden-xs">{{ trans('common.text.followers') }}</div>
        </a>
    </div>
</div>
