...
<div class="main">
        ...
        <div class="col col-md-9 container-book">
            <div class="top-book">
                <div class="detail-book">
                    ...
                    <ul>
                        <li>
                            <strong>{{ trans('form.label.author') }}: </strong>
                                {{ $data['item']['book']->author->name }}
                        </li>
                        <li>
                            <strong>{{ trans('form.label.category') }}: </strong>
                ...
                <div class="rating-container rating-md rating-animate">
                    ...
                    <br>
                    <a href="#review">
                        {{ $data['item']['book']->reviews->count() }} {{ trans('form.label.review') }}
                    </a>
                </div>
                <div class="woo-wrapper-button" data-id="{{ $data['item']['book']->id }}">
                    ...
                    <a href="javascript:void(0)" {{ modalLogin() }} class="{{ attrUser('add-status-read-book') }}"
                        ...
                        ">
                        </span>{{ trans('common.text.reading') }}
                    </a>
                </div>
                <div class="description-book">
                    <p>
                        {{ mb_strimwidth($data['item']['book']->description, 0, 500, '...') }}
                        <a href="#more">{{ trans('common.text.more') }}</a>
                    </p>
                </div>
            </div>
    ...
    <h4 class="border" id="more">{{ trans('common.book.introduce_book') }}</h4>
    <div class="introduce-book">
        <div class="introduce-author pull-right col-md-3">
            <h5 class="title">{{ trans('common.book.author') }}</h5>
    ...
    <h4>{{ trans('common.book.introduce_detail_book') }}</h4>
    ...
    <div class="wrapper-star">
        <div class="row">
            ...
            <div class="col col-md-6">
                <div class="request">
                    <h3>{{ trans('common.text.felling_book') }} </h3>
                    <a href="javascript:void(0)" id="{{ attrUser('see-also') }}" {{ modalLogin() }} class="btn btn-primary">
                       @if (auth()->check())
                            <i class="glyphicon glyphicon-pencil"></i> {{ trans('common.text.write_reive') }}
                        @else
        ...
        <div class="box-form">
            <h4>{{ trans('text.common.send_request') }}: </h4>
                    ...
                    <div class="content-form-request">
                        {!! Form::open([
                                ...
                                <div class="form-group">
                                    <label for="content">
                                        1. {{ trans('common.star_rating') }}: <div id="star-review-book" class="pull-right"></div>
                                    </label>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="conent">
                                        3. {{ trans('common.this_book_about') }}:
                                    </label>
                                ...
                                <div class="pull-right">
                                    {!! Form::submit(trans('form.button.send'), [
                    ...
                    <div class="review-block-like">
                        <div class="pull-left">
                            @if(auth()->check() && $review->likes->contains('user_id', auth()->user()->id))
                                ...
                                <span class="request">{{ trans('common.text.question_review_about') }}</span>
                            @else
